...
{
    final public const NAME = 'iptc';
    final public const DEFAULT_PRESERVE_KEYS = ['2#116', '2#080', '2#115', '2#110'];
    ...
    public function serialize(ImageMetadata $metadata, array $preserveKeys): string
    {
        ...
        foreach ($preserveKeys as $property) {
            if (str_starts_with((string) $property, '2#') && ($key = (int) substr((string) $property, 2)) && isset($iptc[$key])) {
